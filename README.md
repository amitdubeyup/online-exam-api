...
## 📝 About The Project
Backend REST API service built with Express, MongoDB, designed to handle data persistence and business logic for the Online Exam ecosystem.
...
1.  **Clone the repository**:
    ```bash
    git clone git@github.com:amitdubeyup/online-exam-api.git
    ```
